...
LC_ADTEntry_t LC_DefaultADT[LC_MAX_ACTIONPOINTS] =
{
    ...
    /* #1 WHE Set Capacitor A Active, High Side */
    {
    ...
    /* #2 WHE Set Capacitor B Active, High Side */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #3 WHE Set Capacitor A Active, Low Side */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #4 WHE Set Capacitor B Active, Low Side */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
    ...
    /* #7 WHE Stop Obs Due to Low Active Capacitor */
    {
        .DefaultState        = LC_APSTATE_ACTIVE,
        .MaxPassiveEvents    = 0,
        .MaxPassFailEvents   = 0,
        ...
        .EventType           = CFE_EVS_INFORMATION,
        .EventID             = 1007,
        .EventText           = { "Stopping Obs Due to Low Charge" },
        .RPNEquation         = { /* (WP_0) */
                                 16, 5,
                                 LC_RPN_AND,
                                 5,
